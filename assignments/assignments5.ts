...
let employeeData: { name: string; baseSalary: number; experience: number; yearEndRating: number }[] = [
...
for (let employee of employeeData) {
    ...
    console.log(`${employee.name} gets a hike of ${hikePercentage.toFixed(2)}%`);
}           
